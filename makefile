...
proxy: Main.c config.c cache.c proxy_parse.c
	...
	$(CC) $(CFLAGS) -o proxy proxy_parse.o config.o cache.o auth.o proxy.o
...
coverage: clean
	...
	$(CC) $(CFLAGS) $(COVERAGE_FLAGS) -o proxy proxy_parse.o config.o cache.o auth.o proxy.o
	...
	./tests/run_tests.sh
	gcov proxy_parse.c config.c cache.c auth.c
...
tar:
	tar -cvzf ass1.tgz Main.c README makefile proxy_parse.c proxy_parse.h cache.c cache.h config.c config.h
